...
const register = async (req, res, next) => {
  ...
  try {
    ...
    let user = await User.create({
      ...
      password,
      avatar: {
        public_id: email, // Using email as public_id for simplicity
        secure_url:
    ...
    if (req.file) {
      ...
      user.avatar.secure_url = uploadResponse.secure_url;
    ...
    // Clear password before sending user object in response
...
const forgotPassword = (async (req, res, next) => {
  ...
  const message = `You can reset your password of LMS-App by clicking <a href=${resetPasswordUrl} target="_blank">Reset your password</a>\nIf the above link does not work for some reason then copy paste this link in new tab ${resetPasswordUrl}.\n If you have not requested this, kindly ignore.`;
